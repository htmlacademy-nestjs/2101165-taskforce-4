import { COMMENT_NOT_FOUND } from './task-comment.constant';
import { TaskPostService } from './../task-post/task-post.service';
...
export class TaskCommentService {
  ...
  public async create(dto: CreateCommentDto) {
    ...
    await this.taskPostService.incrementCommentsCounter(taskId, +1);
